...
instance
  ...
  isCategory.id isCategory:𝒰 = incl id-𝒰
  isCategory._◆_ isCategory:𝒰 f g = incl (⟨ f ⟩ ◆-𝒰 ⟨ g ⟩)
  isCategory.unit-l-◆ isCategory:𝒰 = incl refl
  isCategory.unit-r-◆ isCategory:𝒰 = incl refl
  isCategory.unit-2-◆ isCategory:𝒰 = incl refl
  isCategory.assoc-l-◆ isCategory:𝒰 = incl refl
  isCategory.assoc-r-◆ isCategory:𝒰 = incl refl
