...
module _ {A : Monoid₀ 𝑖} where
  ...
  instance
    ...
    isPreorder.reflexive isPreorder:Ideal-r = λ a → reflexive
    isPreorder._⟡_ isPreorder:Ideal-r = λ p q a → p a ⟡ q a
    isPreorder.transp-≤ isPreorder:Ideal-r = {!!}
  --   isPreorder._≤_ isPreorder:Ideal-r = (λ I J -> I ≤ J)
  ...
  instance
    ...
    hasFiniteMeets.terminal-⊤ hasFiniteMeets:Ideal-r = λ a -> incl (λ x → tt)
    hasFiniteMeets._∧_ hasFiniteMeets:Ideal-r I J = ′ ⟨ I ⟩ ∧ ⟨ J ⟩ ′
    hasFiniteMeets.π₀-∧ hasFiniteMeets:Ideal-r = λ a -> incl fst -- incl ⟨ π₀-∧ ⟩
    hasFiniteMeets.π₁-∧ hasFiniteMeets:Ideal-r = λ a -> incl snd -- incl ⟨ π₁-∧ ⟩
    hasFiniteMeets.⟨_,_⟩-∧ hasFiniteMeets:Ideal-r = {!!}
