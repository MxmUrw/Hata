...
map-TypedℒHM : ∀{A B : 𝐅𝐮𝐧𝐜 ℒHMJudgementCategory 𝐂𝐚𝐭₀} -> (A ⟶ B) -> TypedℒHM A ⟶ TypedℒHM B
map-TypedℒHM = {!!}


instance
  isFunctor:TypedℒHM : isFunctor (𝐅𝐮𝐧𝐜 ℒHMJudgementCategory 𝐂𝐚𝐭₀) (𝐅𝐮𝐧𝐜 ℒHMJudgementCategory 𝐂𝐚𝐭₀) (TypedℒHM)
