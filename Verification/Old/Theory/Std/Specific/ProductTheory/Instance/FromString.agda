...
module Verification.Core.Theory.Std.Specific.ProductTheory.Instance.FromString where
...
open import Verification.Core.Theory.Std.Presentation.AnnGraph.Definition
