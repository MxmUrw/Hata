...
byExpand-ι₀,ι₁ : ∀{a b c : ℒHMTypes Σ} -> {f g : a ⊔ b ⟶ c}
                  -> ι₀ ◆ f ∼ ι₀ ◆ g
                  -> ι₁ ◆ f ∼ ι₁ ◆ g
                  -> f ∼ g
...
module assoc-l-⊔' {a b c : ℒHMTypes Σ} where
...
module _ {𝒯 : 𝒰 𝑖} {{_ : isℒHMTypeCtx {𝑗} 𝒯}} where
  ...
  module §-assoc-l-⊔-ℒHMTypes where
    prop-1 : ∀{a b c : ℒHMTypes Σ} -> (ι₀ ◆ ι₀) ◆ ⟨ assoc-l-⊔-ℒHMTypes {a = a} {b} {c} ⟩ ∼ ι₀
    prop-1 = {!!} -- (ι₀ ◆ ι₀) ◆ _  ⟨ assoc-l-◆ ⟩-∼
              -- ι₀ ◆ (ι₀ ◆ _)  ⟨ refl ◈ reduce-ι₀ ⟩-∼
              -- ι₀ ◆ _         ⟨ reduce-ι₀ ⟩-∼
              -- ι₀             ∎

    prop-1' : ∀{a b c : ℒHMTypes Σ} -> (ι₀ ◆ ι₀) ∼ ι₀ ◆ ⟨ assoc-l-⊔-ℒHMTypes {a = a} {b} {c} ⟩⁻¹
    prop-1' = switch-≅-r {f = ι₀ ◆ ι₀} {ψ = assoc-l-⊔-ℒHMTypes} {g = ι₀} prop-1

    prop-2 : ∀{a b c x : ℒHMTypes Σ}
            -> {f : a ⟶ x} {g : b ⟶ x} {h : c ⟶ x}
            -> ⦗ f , ⦗ g , h ⦘ ⦘ ∼ ⟨ assoc-l-⊔-ℒHMTypes ⟩⁻¹ ◆ ⦗ ⦗ f , g ⦘ , h ⦘
    prop-2 {f = f} {g} {h} = byExpand-ι₀,ι₁ lem-1 (byExpand-ι₀,ι₁ lem-2 lem-3)
      where
        lem-1 : ι₀ ◆ ⦗ f , ⦗ g , h ⦘ ⦘ ∼ ι₀ ◆ (⟨ assoc-l-⊔-ℒHMTypes ⟩⁻¹ ◆ ⦗ ⦗ f , g ⦘ , h ⦘)
        lem-1 = ι₀ ◆ ⦗ f , ⦗ g , h ⦘ ⦘   ⟨ reduce-ι₀ ⟩-∼
                f                                                   ⟨ reduce-ι₀ ⁻¹ ⟩-∼
                ι₀ ◆ ⦗ f , g ⦘                                      ⟨ refl ◈ reduce-ι₀ ⁻¹ ⟩-∼
                ι₀ ◆ (ι₀ ◆ ⦗ ⦗ f , g ⦘ , h ⦘)                       ⟨ assoc-r-◆ ⟩-∼
                (ι₀ ◆ ι₀) ◆ ⦗ ⦗ f , g ⦘ , h ⦘                       ⟨ reduce-ι₀ ⁻¹ ◈ refl ⟩-∼
                (ι₀ ◆ ⟨ assoc-l-⊔-ℒHMTypes ⟩⁻¹) ◆ ⦗ ⦗ f , g ⦘ , h ⦘   ⟨ assoc-l-◆ ⟩-∼
                ι₀ ◆ (⟨ assoc-l-⊔-ℒHMTypes ⟩⁻¹ ◆ ⦗ ⦗ f , g ⦘ , h ⦘)   ∎

        lem-2 : ι₀ ◆ (ι₁ ◆ ⦗ f , ⦗ g , h ⦘ ⦘) ∼ ι₀ ◆ (ι₁ ◆ (⟨ assoc-l-⊔-ℒHMTypes ⟩⁻¹ ◆ ⦗ ⦗ f , g ⦘ , h ⦘))
        lem-2 = ι₀ ◆ (ι₁ ◆ ⦗ f , ⦗ g , h ⦘ ⦘)   ⟨ refl ◈ reduce-ι₁ ⟩-∼
                ...
                ι₀ ◆ (ι₁ ◆ (⟨ assoc-l-⊔-ℒHMTypes ⟩⁻¹ ◆ ⦗ ⦗ f , g ⦘ , h ⦘))   ∎

        lem-3 : ι₁ ◆ (ι₁ ◆ ⦗ f , ⦗ g , h ⦘ ⦘) ∼ ι₁ ◆ (ι₁ ◆ (⟨ assoc-l-⊔-ℒHMTypes ⟩⁻¹ ◆ ⦗ ⦗ f , g ⦘ , h ⦘))
